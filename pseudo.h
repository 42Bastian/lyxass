...
const struct opcode_s pseudo[]={
    ...
    { "MACRO",p_macro,0},
    { "ENDM",p_endm,0},
    { "DB",p_definebyte,0},{"DC\016B",p_definebyte,0},
    { "DA",p_definebyte,1},{"DC\016A",p_definebyte,1},
    { "DW",p_defineword,0},{"DC\016W",p_defineword,0},
    { "DW",p_definelong,0},{"DC\016L",p_definelong,0},
    { "DS\016B",p_definespace,1},{"DS",p_definespace,1},
    { "DS\016W",p_definespace,2},
    { "DS\016L",p_definespace,4},
    { "INCLUDE",p_include,0},
    { "ISYMS",p_isyms,0},
    { "TRANS",p_trans,0},
    { "PATH",p_path,0},
